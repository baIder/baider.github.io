...
index_img: https://img.bald3r.wang/img/2024-04-11-202404111114631.png
categories:
  - 前端工程化
tags:
  - 阿里云效
...
![image.png](https://img.bald3r.wang/img/2024-04-10-202404101414759.png)

### 选择模板

这里还是以笔者上一篇文章中的 Node 项目为例（Vue3+Vite），由于给出的模板中都有测试阶段，因此笔者这里选择`空模板`：

![image.png](https://img.bald3r.wang/img/2024-04-10-202404101444643.png)

点击创建后，进入流水线的编辑页面：

![image.png](https://img.bald3r.wang/img/2024-04-10-202404101446004.png)
...
![image.png](https://img.bald3r.wang/img/2024-04-10-202404101450136.png)

第一次进入的话需要点击新建，会自动跳转到 Github 认证页面，点击绿色的授权按钮，然后输入 Github 密码确认就可以了。

如果认证完成了之后，返回 云效 页面还是没有显示，就关闭这个对话框，重新打开，就能选取了：

![image.png](https://img.bald3r.wang/img/2024-04-10-202404101452363.png)

点击`创建`：

记得要选择刚刚创建的服务连接，笔者在尝试的时候并没有自动选中。

![image.png](https://img.bald3r.wang/img/2024-04-10-202404101453441.png)

选择对应的仓库及分支，其余选项按需选择，这里笔者都保持默认：

![image.png](https://img.bald3r.wang/img/2024-04-10-202404101455426.png)

点击`添加`：

![image.png](https://img.bald3r.wang/img/2024-04-10-202404101456191.png)

### 打包阶段配置

点击`空任务`：

![image.png](https://img.bald3r.wang/img/2024-04-10-202404101457567.png)
...
![image.png](https://img.bald3r.wang/img/2024-04-10-202404101500620.png)

![image.png](https://img.bald3r.wang/img/2024-04-10-202404101502566.png)
...
![image.png](https://img.bald3r.wang/img/2024-04-10-202404101514857.png)
...
![image.png](https://img.bald3r.wang/img/2024-04-10-202404101540429.png)
...
![image.png](https://img.bald3r.wang/img/2024-04-10-202404101540873.png)
...
![image.png](https://img.bald3r.wang/img/2024-04-10-202404101547855.png)

![image.png](https://img.bald3r.wang/img/2024-04-10-202404101548426.png)
...
![image.png](https://img.bald3r.wang/img/2024-04-10-202404101556238.png)

选择 部署 -> 主机部署：

>这里如果读者服务器是阿里云ECS服务器，可以直接选择 `ECS应用部署`

![image.png](https://img.bald3r.wang/img/2024-04-10-202404101619942.png)

`制品`选择上一步的制品：

![image.png](https://img.bald3r.wang/img/2024-04-10-202404101621829.png)

如果之前没有配置过主机组，这里点击`新建主机组`：

跳转到`主机组管理`，选择`新建主机组`，新建完成后进入这个主机组，选择`添加新主机`：

![image.png](https://img.bald3r.wang/img/2024-04-10-202404101611104.png)
...
![image.png](https://img.bald3r.wang/img/2024-04-10-202404101606743.png)

然后会跳转阿里云 RAM 控制访问中心授权，同意授权即可。

选择刚刚添加的服务连接，选择服务区所在地域，就能找到自己的服务器了。

![image.png](https://img.bald3r.wang/img/2024-04-10-202404101607741.png)
...
![image.png](https://img.bald3r.wang/img/2024-04-10-202404101612015.png)

![image.png](https://img.bald3r.wang/img/2024-04-10-202404101613963.png)

出现上图中的`status running`就说明安装成功了，点击页面的刷新按钮，就可以看到服务器成功添加了：

![image.png](https://img.bald3r.wang/img/2024-04-10-202404101614920.png)
...
![image.png](https://img.bald3r.wang/img/2024-04-10-202404101624074.png)
...
![image.png](https://img.bald3r.wang/img/2024-04-10-202404101633119.png)
...
![image.png](https://img.bald3r.wang/img/2024-04-10-202404101634326.png)

`部署策略`选择`不暂停`：

![image.png](https://img.bald3r.wang/img/2024-04-10-202404101634054.png)

#### 钉钉通知

这一步可以选择开启钉钉机器人通知，配置方法和[上一篇 Jenkins](https://juejin.cn/post/7354406980784504870#heading-12) 类似：

![image.png](https://img.bald3r.wang/img/2024-04-10-202404101635186.png)

![image.png](https://img.bald3r.wang/img/2024-04-10-202404101635529.png)
...
![image.png](https://img.bald3r.wang/img/2024-04-10-202404101639783.png)

![image.png](https://img.bald3r.wang/img/2024-04-10-202404101641792.png)

显示部署成功，登录服务器查看文件：

![image.png](https://img.bald3r.wang/img/2024-04-10-202404101642894.png)

打开网页试一下：

![image.png](https://img.bald3r.wang/img/2024-04-10-202404101644451.png)
...
![image.png](https://img.bald3r.wang/img/2024-04-10-202404101650161.png)

复制下面的`Webhook`链接，然后在 Github 仓库设置里添加这个 Webhook ，注意这里的`Content--type`要选择`application/json`，否则接口会报错：

![image.png](https://img.bald3r.wang/img/2024-04-11-202404111054112.png)

随便改动代码并提交，可以看到已经自动触发构建了：

![image.png](https://img.bald3r.wang/img/2024-04-11-202404111045914.png)

笔者这里失败了，原因是 Github 连接失败：

![image.png](https://img.bald3r.wang/img/2024-04-11-202404111046085.png)

所以 Github 项目还是推荐香港集群，如果必须用北京集群的话，可以多试几次，一般就能成功。

![image.png](https://img.bald3r.wang/img/2024-04-11-202404111048319.png)

刷新网页，可以看到更新内容也成功显示了：

![image.png](https://img.bald3r.wang/img/2024-04-11-202404111055414.png)
